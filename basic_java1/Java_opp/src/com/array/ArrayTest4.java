...
public class ArrayTest4 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < intBoxes.length; i++) {
            // i = 0, intBox[0] = 랜덤 숫자 하나 저장
            // i = 1, intBox[0] = 랜덤 숫자 하나 저장
            // i = 2, intBox[0] = 랜덤 숫자 하나 저장
            // i = 3, intBox[0] = 랜덤 숫자 하나 저장
            // i = 4, intBox[0] = 랜덤 숫자 하나 저장
            // i = 5, intBox[0] = 랜덤 숫자 하나 저장
        ...
        System.out.println("----------------------");
        System.out.println(intBoxes[0]);

        for (int i = 0; i < intBoxes.length; i ++){
            // 역슬래시(엔터위) \   <<이스케이프 문자 - 문자로 보지말고, 명령어로 인식해 t <-- 탭 간격
